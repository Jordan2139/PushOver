...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if Vehicle.Vehicle ~= nil then
            ...
            if IsControlPressed(0, Config.KeyToUse1) and IsVehicleSeatFree(Vehicle.Vehicle, -1) and not IsEntityAttachedToEntity(ped, Vehicle.Vehicle) and IsControlJustPressed(0, Config.KeyToUse2) then
                ...
                while true do
                    ...
                    if not IsDisabledControlPressed(0, Config.KeyToUse2) then
